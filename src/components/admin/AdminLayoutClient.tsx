...
import {
    ...
    Megaphone, Globe, Mail, Layers, Receipt, Tag
} from 'lucide-react';
                ...
                <div className="h-20 flex items-center px-8 border-b border-brand-glass-border gap-4">
                    <Link href="/admin/dashboard" className="flex items-center gap-3">
                        <span className="font-display font-bold text-xl text-brand-text">
                            Jo<span className="gradient-text">vero</span>
                        </span>
                    </Link>
                    <button
                ...
                <header className="sticky top-0 z-40 h-20 bg-brand-dark/50 backdrop-blur-xl border-b border-brand-glass-border flex items-center justify-between px-6 lg:px-10">
                    ...
                    <div className="flex items-center gap-4">
                        <Link
                            href="/"
                            target="_blank"
                            className="px-4 py-2 rounded-lg text-xs font-bold uppercase tracking-widest text-brand-accent bg-brand-accent/5 border border-brand-accent/20 hover:bg-brand-accent hover:text-brand-primary transition-all duration-300 shadow-neon-purple/10"
                        >
                            View Site
                        </Link>
                    </div>
