...
import { Menu, X, Globe, Home, Users, Cpu, Briefcase, Monitor, FileText, MessageCircle, Phone, Facebook, Instagram, Tag } from 'lucide-react';
...
export function Navbar({ dict, lang, getStartedText }: { dict: any, lang: string, getStartedText?: string }) {
    ...
    const navLinks = [
        ...
        { href: `/${lang}/pricing`, label: dict?.navbar?.pricing || 'Pricing', icon: Tag },
